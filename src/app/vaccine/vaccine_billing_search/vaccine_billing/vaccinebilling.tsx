...
import BILLS from "@/assets/vaccine_billings.js";
...
const VaccineBilling: React.FC = () => {
  const heading = (
    <span>
      <span className="text-[#999999]">Vaccine</span> &gt;{" "}
      <span className="text-[#475467]">Vaccine Billing Search</span> &gt;{" "}
      <span className="text-[#475467]">Vaccine Billing</span>
    </span>
  );
  ...
  const formatForComparison = (dateString: string) => {
    const normalized = normalizeDate(dateString);
        ...
        const filteredBills = useMemo(() => {
          return localBills.filter((bill) => {
            ...
            const dateMatch = !selectedDate || 
              normalizeDate(bill.createdAt) === normalizeDate(selectedDate);
        ...
        <div className="relative flex items-center gap-2">
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                value={selectedDate ? formatForComparison(selectedDate) : ''}
              />
            </div>
          </div>
        </div>  
