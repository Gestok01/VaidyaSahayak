...
const DynamicReceiveInventoryForm: React.FC<DynamicCostFormProps> = ({
  pageName,
  sections,
  onSave,
}) => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="ml-4 p-4 flex items-center gap-3 -mt-7">
        ...
        <span className="text-[#4D4D4D] text-[40px] pb-2">&rsaquo;</span>
        <span className="text-[#4D4D4D] text-xl font-semibold">
          Search
        </span>
        <span className="text-[#4D4D4D] text-[40px] pb-2">&rsaquo;</span>
        <span className="text-[#4D4D4D] text-xl font-semibold">
      ...
      <div className="p-4 border-b border-[#999999]">
...
export default DynamicReceiveInventoryForm;