...
import TEST_INCOME_DATA from "../../../../assets/test_income_data.json";
import Accountsvg from "../../../../assets/svg/settings_account_box.svg";

const TestIncomeTable: React.FC = () => {
  const heading = (
    <div className="flex items-center whitespace-nowrap overflow-hidden">
      ...
      <span className="text-[#999999]">Test Total Income</span>
      <span className="mx-1 text-[#999999]">&gt;</span>
      <span className="text-[#999999]">Search</span>
      <span className="mx-1 text-[#999999]">&gt;</span>
      <span className="text-[#4D4D4D]">Test Income Details List</span>
    </div>
  );
  
  const [incomeData] = useState(TEST_INCOME_DATA);
  ...
  return (
    <div className="px-6 py-3 shadow-lg rounded-xl">
      ...
      <div className="flex justify-between items-center bg-gray-50 px-6 py-2 border-x-2 border-t-2 rounded-t-md border-gray-200">
        <span className="font-semibold text-xs font-normal">Test Income Details (Date)</span>
      </div>

      {/* Read-Only Dynamic Table */}
...
export default TestIncomeTable;